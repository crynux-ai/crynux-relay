...
//
// Solidity: function getTask(bytes32 taskIDCommitment) view returns((uint8,address,bytes32,bytes32,bytes32,uint256,uint8,address,uint256,bytes,uint256,uint256,string,uint256,string,uint256,string,uint8,uint8,address[],uint256[],uint256,uint256))
