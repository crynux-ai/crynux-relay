...
// ReportTaskSuccess is a paid mutator transaction binding the contract method 0x510df894.
//
// Solidity: function reportTaskSuccess(uint256 taskId, uint256 round) returns()
func (_Task *TaskTransactor) ReportTaskSuccess(opts *bind.TransactOpts, taskId *big.Int, round *big.Int) (*types.Transaction, error) {
	return _Task.contract.Transact(opts, "reportTaskSuccess", taskId, round)
}

// ReportTaskSuccess is a paid mutator transaction binding the contract method 0x510df894.
//
// Solidity: function reportTaskSuccess(uint256 taskId, uint256 round) returns()
func (_Task *TaskSession) ReportTaskSuccess(taskId *big.Int, round *big.Int) (*types.Transaction, error) {
	return _Task.Contract.ReportTaskSuccess(&_Task.TransactOpts, taskId, round)
}

// ReportTaskSuccess is a paid mutator transaction binding the contract method 0x510df894.
//
// Solidity: function reportTaskSuccess(uint256 taskId, uint256 round) returns()
func (_Task *TaskTransactorSession) ReportTaskSuccess(taskId *big.Int, round *big.Int) (*types.Transaction, error) {
	return _Task.Contract.ReportTaskSuccess(&_Task.TransactOpts, taskId, round)
}
