...
//
// Solidity: function getTask(uint256 taskId) view returns((uint256,address,bytes32,bytes32,bool,address[],bytes32[],bytes32[],bytes[],uint256[]))
