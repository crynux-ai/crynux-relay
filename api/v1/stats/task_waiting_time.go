...
type GetTaskWaitingTimeHistogramInput struct {
...
type GetTaskWaitingTimeHistogramData struct {
	WaitingTimes []int64 `json:"upload_result_times"`
	TaskCounts   []int64 `json:"task_count"`
}

type GetTaskWaitingTimeHistogramResponse struct {
	response.Response
	Data *GetTaskWaitingTimeHistogramData `json:"data"`
}
...
func GetTaskWaitingTimeHistogram(_ *gin.Context, input *GetTaskWaitingTimeHistogramInput) (*GetTaskWaitingTimeHistogramResponse, error) {
	...
	return &GetTaskWaitingTimeHistogramResponse{
		Data: &GetTaskWaitingTimeHistogramData{
			WaitingTimes: seconds,
			TaskCounts:   counts,
		},
	}, nil
}
