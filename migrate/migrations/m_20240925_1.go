...
func M20240925_1(db *gorm.DB) *gormigrate.Gormigrate {
	...
	return gormigrate.New(db, gormigrate.DefaultOptions, []*gormigrate.Migration{
		{
			...
			Migrate: func(tx *gorm.DB) error {
				...
				if err := tx.Migrator().CreateIndex(&TaskCount{}, "Start"); err != nil {
					return err
				}
				...
				if err := tx.Migrator().CreateIndex(&TaskExecutionTimeCount{}, "Start"); err != nil {
					return err
				}
			...
			Rollback: func(tx *gorm.DB) error {
				...
				if err := tx.Migrator().DropIndex(&TaskExecutionTimeCount{}, "Start"); err != nil {
					return err
				}
				...
				if err := tx.Migrator().DropIndex(&TaskCount{}, "Start"); err != nil {
					return err
				}
